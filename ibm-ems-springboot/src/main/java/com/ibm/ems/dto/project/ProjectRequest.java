...
public class ProjectRequest {
	...
	@Schema(description = "Project name", example = "YONO 2.0", requiredMode = Schema.RequiredMode.REQUIRED)
	...
	@Schema(description = "Project start date (YYYY-MM-DD)", example = "2024-01-15", requiredMode = Schema.RequiredMode.REQUIRED)
	@NotNull(message = "Start date is required")
	private LocalDate startDate;

	@Schema(description = "Project end date (YYYY-MM-DD) — optional for ongoing projects", example = "2024-12-31")
	private LocalDate endDate;

	@Schema(description = "Project status", example = "PLANNED", requiredMode = Schema.RequiredMode.REQUIRED)
